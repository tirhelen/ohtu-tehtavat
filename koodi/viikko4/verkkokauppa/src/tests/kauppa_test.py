...
class TestKauppa(unittest.TestCase):
    ...
    def test_oikea_asiakas_tilinumero_ja_summa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kaksi_samaa_tuotetta_oikeat_arvot(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kaksi_eri_tuotetta_oikea_asiakasjne(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuote_saatavilla_ja_tuote_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
